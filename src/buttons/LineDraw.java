...
public class LineDraw extends JLabel implements MouseListener {
	...
	public LineDraw(CanvasPanel cv) {
		iconUrl = getClass().getClassLoader().getResource("./images/linesegment.png");
